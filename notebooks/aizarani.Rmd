...
mapHepQuery <- function(query_name) {
  
  query <- data.obj[[query_name]]
...
```{r}
low1.mapped <- mapHepQuery("low1")
low2.mapped <- mapHepQuery("low2")
